...
for %%i in (src\*.cpp) do (
    echo Building %%i
    tools\avr8-gnu-toolchain-win32_x86_64\bin\avr-gcc.exe -mmcu=attiny1624 -B tools\atpack\Atmel.ATtiny_DFP.2.0.368\gcc\dev\attiny1624  -I tools\atpack\Atmel.ATtiny_DFP.2.0.368\include\ -DF_CPU=5000000UL -c -o build\%%~ni.o %%i
)
